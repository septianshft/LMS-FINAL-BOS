    ...
    <div class="container">
            ...
            <div class="col-lg-12">
                <div class="res-control d-flex align-items-center justify-content-between">
                    <div class="section-title mb-0">
                        <span class="title-head builder-editable" builder-identity="1">Courses</span>
                        <h2 class="title builder-editable" builder-identity="2">Featured Courses</h2>
                    </div>
                    <span class="featured-course-all-button">
                        <a href="courses.html" class="eBtn gradient builder-editable" builder-identity="3">View All Courses</a>
                    </span>
                </div>
            </div>
        </div>
        <span class="featured-course">
            <div class="row mt-50 gx-5">
                <!-- Contoh Kursus Unggulan 1 -->
                <div class="col-lg-6 col-md-12 col-sm-6 mb-30">
                    <a href="course-details-1.html" class="single-feature p-15 w-100 checkPropagation">
                        <div class="row">
                            <div class="col-lg-5 col-md-5">
                                <div class="courses-img">
                                    <img class="h-190" src="path/to/static/image/course-thumbnail-1.jpg" alt="Course Thumbnail">
                                    <div class="cText d-flex">
                                        <h4>Rp 250.000</h4> 
                                        <!-- Atau <del>Rp 300.000</del> jika ada diskon, atau <h4>FREE</h4> -->
                                    </div>
                                    <!-- Logika Wishlist bisa dihilangkan atau diganti ikon statis -->
                                    <span data-bs-toggle="tooltip" data-bs-title="Add to wishlist" class="heart checkPropagation"><i class="fa-regular fa-heart"></i></span>
                                </div>
                            </div>
                            <div class="col-lg-7 col-md-7">
                                <div class="entry-details">
                                    <div class="entry-title">
                                        <h3 class="ellipsis-line-2">Nama Kursus Unggulan Statis 1 yang Menarik</h3>
                                    </div>
                                    <ul>
                                        <li>
